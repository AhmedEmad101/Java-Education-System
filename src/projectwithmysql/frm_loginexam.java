...
public class frm_loginexam extends javax.swing.JFrame {
ResultSet RS=null;
...
if(((txtname.getText().toString()).equals(nameteacher))&& (txtpass.getText().toString()).equals(password))
       {
           frm_teacherexam frmteacher=new frm_teacherexam();
...
//        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new frm_loginexam().setVisible(true);
            }
        });
    }
